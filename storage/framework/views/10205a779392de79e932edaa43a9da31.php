...
<head>
    ...
    <title>Edit DUDI - Aplikasi PKL SMK Islam 1 Blitar</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome@6.4.0/css/all.min.css">
    <style>
        /* Styles sama dengan tambah-dudi.blade.php */
        :root {
    ...
    <div id="content">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Form Edit Data DUDI</h5>
            </div>
            <div class="card-body">
                ...
                <div class="info-box">
                    ...
                    <span class="badge bg-<?php echo e($dudi->status == 'tersedia' ? 'success' : 'danger'); ?>">
                        <?php echo e($dudi->status == 'tersedia' ? 'Tersedia' : 'Penuh'); ?>

                    </span>
                    | <strong>Terisi:</strong> <?php echo e($dudi->terisi); ?> dari <?php echo e($dudi->kuota); ?> siswa
                </div>

                <form method="POST" action="<?php echo e(route('admin.update-dudi', $dudi->id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_dudi" name="nama_dudi" required
                                value="<?php echo e(old('nama_dudi', $dudi->nama_dudi)); ?>" placeholder="Masukkan nama DUDI">
                        </div>
                        <div class="col-md-6">
                            <label for="no_telp" class="form-label required-field">No. Telepon</label>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" required
                                value="<?php echo e(old('no_telp', $dudi->no_telp)); ?>" placeholder="Contoh: 085815579285">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="jenis_usaha" name="jenis_usaha" required
                                value="<?php echo e(old('jenis_usaha', $dudi->jenis_usaha)); ?>" placeholder="Contoh: Bengkel, Teknologi, dll">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_pimpinan" name="nama_pimpinan" required
                                value="<?php echo e(old('nama_pimpinan', $dudi->nama_pimpinan)); ?>" placeholder="Nama pimpinan DUDI">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="kuota" name="kuota" required
                                value="<?php echo e(old('kuota', $dudi->kuota)); ?>" placeholder="Jumlah kuota siswa" min="<?php echo e($dudi->terisi); ?>">
                            <small class="text-muted">Minimal kuota: <?php echo e($dudi->terisi); ?> (sesuai jumlah yang sudah terisi)</small>
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="alamat_dudi" name="alamat_dudi" rows="3" required
                                placeholder="Masukkan alamat lengkap DUDI"><?php echo e(old('alamat_dudi', $dudi->alamat_dudi)); ?></textarea>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('admin.data-dudi')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\laragon\www\pkl2\resources\views/admin/edit-dudi.blade.php ENDPATH**/ ?>
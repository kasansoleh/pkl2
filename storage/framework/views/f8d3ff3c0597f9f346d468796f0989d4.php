        ...
        <div class="row stats-cards">
            <div class="col-xl-3 col-md-6">
                <div class="stat-card pengajuan">
                    ...
                    <div class="stat-number"><?php echo e($pengajuanMenunggu); ?></div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="stat-card diterima">
                    ...
                    <div class="stat-number"><?php echo e($pengajuanDiterima); ?></div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="stat-card ditolak">
                    ...
                    <div class="stat-number"><?php echo e($pengajuanDitolak); ?></div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6">
                <div class="stat-card">
                    ...
                    <h5>Total Admin</h5>
                    <div class="stat-number"><?php echo e($totalAdmin); ?></div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\pkl2\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
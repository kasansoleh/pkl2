    ...
    <div id="content">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('admin.tambah-dudi.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_dudi" name="nama_dudi" required
                                value="<?php echo e(old('nama_dudi')); ?>" placeholder="Masukkan nama DUDI">
                        </div>
                        <div class="col-md-6">
                            <label for="no_telp" class="form-label required-field">No. Telepon</label>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" required
                                value="<?php echo e(old('no_telp')); ?>" placeholder="Contoh: 085815579285">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="jenis_usaha" name="jenis_usaha" required
                                value="<?php echo e(old('jenis_usaha')); ?>" placeholder="Contoh: Bengkel, Teknologi, dll">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_pimpinan" name="nama_pimpinan" required
                                value="<?php echo e(old('nama_pimpinan')); ?>" placeholder="Nama pimpinan DUDI">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="kuota" name="kuota" required
                                value="<?php echo e(old('kuota')); ?>" placeholder="Jumlah kuota siswa" min="1">
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="alamat_dudi" name="alamat_dudi" rows="3" required
                                placeholder="Masukkan alamat lengkap DUDI"><?php echo e(old('alamat_dudi')); ?></textarea>
                        </div>
                    </div>
...
</html><?php /**PATH C:\laragon\www\pkl2\resources\views/admin/tambah-dudi.blade.php ENDPATH**/ ?>
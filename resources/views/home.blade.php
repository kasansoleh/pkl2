...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">PKL SMK Islam 1 Blitar</a>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <div class="alert alert-info mt-4">
                <h5>Hai, {{ $siswa->nama }}!</h5>
                <p class="mb-0">Anda sudah login sebagai siswa. <a href="{{ route('dashboard') }}">Klik di sini</a> untuk menuju dashboard.</p>
            </div>
        @else
            <a href="{{ route('login') }}" class="btn btn-light btn-lg mt-3">Login Siswa</a>
        @endif
    </div>
</section>
        </div>

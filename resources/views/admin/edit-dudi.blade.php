        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="info-box">
                    ...
                    <span class="badge bg-{{ $dudi->status == 'tersedia' ? 'success' : 'danger' }}">
                        {{ $dudi->status == 'tersedia' ? 'Tersedia' : 'Penuh' }}
                    </span>
                    | <strong>Terisi:</strong> {{ $dudi->terisi }} dari {{ $dudi->kuota }} siswa
                </div>

                <form method="POST" action="{{ route('admin.update-dudi', $dudi->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_dudi" name="nama_dudi" required
                                value="{{ old('nama_dudi', $dudi->nama_dudi) }}" placeholder="Masukkan nama DUDI">
                        </div>
                        <div class="col-md-6">
                            <label for="no_telp" class="form-label required-field">No. Telepon</label>
                            <input type="text" class="form-control" id="no_telp" name="no_telp" required
                                value="{{ old('no_telp', $dudi->no_telp) }}" placeholder="Contoh: 085815579285">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="jenis_usaha" name="jenis_usaha" required
                                value="{{ old('jenis_usaha', $dudi->jenis_usaha) }}" placeholder="Contoh: Bengkel, Teknologi, dll">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_pimpinan" name="nama_pimpinan" required
                                value="{{ old('nama_pimpinan', $dudi->nama_pimpinan) }}" placeholder="Nama pimpinan DUDI">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="kuota" name="kuota" required
                                value="{{ old('kuota', $dudi->kuota) }}" placeholder="Jumlah kuota siswa" min="{{ $dudi->terisi }}">
                            <small class="text-muted">Minimal kuota: {{ $dudi->terisi }} (sesuai jumlah yang sudah terisi)</small>
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="alamat_dudi" name="alamat_dudi" rows="3" required
                                placeholder="Masukkan alamat lengkap DUDI">{{ old('alamat_dudi', $dudi->alamat_dudi) }}</textarea>
                        </div>
                    </div>

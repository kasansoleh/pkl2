    ...
    <div id="content">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <a href="{{ route('admin.tambah-dudi') }}" class="btn btn-tambah">
                        ...
                        <tbody>
                            @if($dudi->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->kuota }}</td>
                                   <td>
    <a href="{{ route('admin.edit-dudi', $d->id) }}" class="btn btn-edit btn-aksi">
        <i class="fas fa-edit"></i> Ubah
    </a>
    <form action="{{ route('admin.hapus-dudi', $d->id) }}" method="POST" class="d-inline">
        @csrf
        @method('DELETE')
        <button type="submit" class="btn btn-hapus btn-aksi" 
            ...
            <i class="fas fa-trash"></i> Hapus
                                ...
                                <tr>
                                    <td colspan="7" class="text-center">
                                        <div class="py-4">
                                            ...
                                            <a href="{{ route('admin.tambah-dudi') }}" class="btn btn-tambah mt-2">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        Showing {{ $dudi->firstItem() }} to {{ $dudi->lastItem() }} of {{ $dudi->total() }} entries
                    </div>
                    <nav>
                        {{ $dudi->links() }}
                    </nav>
